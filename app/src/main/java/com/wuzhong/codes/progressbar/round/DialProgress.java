...
public class DialProgress extends View {
    ...
    private void initConfig(Context context, AttributeSet attrs) {
        ...
        mMaxValue = typedArray.getFloat(R.styleable.DialProgress_maxValue, ConstantUtil.DEFAULT_MAX_VALUE);
        mValue = typedArray.getFloat(R.styleable.DialProgress_value, ConstantUtil.DEFAULT_VALUE);
        mValueSize = typedArray.getDimension(R.styleable.DialProgress_valueSize, ConstantUtil.DEFAULT_VALUE_SIZE);
        ...
        mUnitSize = typedArray.getDimension(R.styleable.DialProgress_unitSize, ConstantUtil.DEFAULT_UNIT_SIZE);
        ...
        mHintSize = typedArray.getDimension(R.styleable.DialProgress_hintSize, ConstantUtil.DEFAULT_HINT_SIZE);

        mArcWidth = typedArray.getDimension(R.styleable.DialProgress_arcWidth, ConstantUtil.DEFAULT_ARC_WIDTH);

        mStartAngle = typedArray.getFloat(R.styleable.DialProgress_startAngle, ConstantUtil.DEFAULT_START_ANGLE);
        mSweepAngle = typedArray.getFloat(R.styleable.DialProgress_sweepAngle, ConstantUtil.DEFAULT_SWEEP_ANGLE);

        mAnimTime = typedArray.getInt(R.styleable.DialProgress_animTime, ConstantUtil.DEFAULT_ANIM_TIME);
